...
error_log("Procesando eliminación de usuario con id_usuario: $idUsuario para admin: {$_SESSION['usuario']}");
...
try {
    ...
    $conexion->commit();
    echo json_encode(["exito" => true, "mensaje" => "Usuario y datos asociados eliminados correctamente."]);
} catch (Exception $e) {
    $conexion->rollback();
